...
if (productCount > 0 && ingredientCount > 0 && redFlagCount > 0) {
  console.log(`Database already seeded (${productCount} products, ${ingredientCount} ingredients, ${redFlagCount} red flags). Skipping.`);
  process.exit(0);
}
