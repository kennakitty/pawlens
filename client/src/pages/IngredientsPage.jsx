    ...
    return (
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ background: colors.card, border: `1px solid ${colors.border}`, borderRadius: 12, padding: 28 }}>
          ...
          <div style={{ padding: 16, background: colors.primaryLight, borderRadius: 8, marginBottom: 24 }}>
        ...
        <div style={{ display: "grid", gap: 12 }}>
          {filtered.map((ing) => (
            <div key={ing.id} onClick={() => setSelectedIngredient(ing)}
              style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: colors.card, border: `1px solid ${colors.border}`, borderRadius: 10, padding: "16px 20px", cursor: "pointer", transition: "box-shadow 0.2s" }}
